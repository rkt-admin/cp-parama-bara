<div>
    ...
    <div class="grid grid-cols-3 md:gap-10 mt-10">
        ...
        <div class="flex flex-col items-center" data-aos="fade-up" data-aos-duration="1000" data-aos-delay="1000">
            ...
            <p class="mt-6 font-normal text-xs text-center">To become a vertically integrated energy trading company that adds value across the entire energy value chain</p>
        </div>
    </div>
</div>