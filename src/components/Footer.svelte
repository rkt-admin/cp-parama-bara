...
<footer class="mx-auto flex flex-col flex-grow w-full max-w-3xl mt-10 pt-10">
  <div class="md:flex md:justify-between">
    <div>
      ...
      <ul>
        ...
        <li class="mb-3">
          <a href="/term-condition">Terms of Services</a>
        </li>
        <li class="mb-3">
  ...
  <div class="sm:flex sm:items-center sm:justify-between mb-4 ">
    <span class="text-sm text-gray-500 sm:text-center dark:text-gray-400"
      ><i class="fa-regular fa-copyright"></i> 2022 <a href={website}>Rakit.id</a> by PT Rakit Media Group, All Rights Reserved.
    </span>
    <div class="flex mt-4 space-x-4 sm:justify-center sm:mt-0 items-center">
      <!-- svelte-ignore a11y-invalid-attribute -->
...
<style lang="postcss">
  ...
  footer a {
    @apply text-slate-500 mb-6 text-sm font-normal;
  }
  footer a:hover {
    @apply text-sky-400;
  }
