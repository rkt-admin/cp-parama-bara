          ...
          <div class="flex flex-wrap justify-between mb-12 lg:mb-0 ">
            <div class="flex max-w-full w-[330px] mb-8">
              ...
              <div>
                ...
                <p class="text-base text-body-color">
                  Jl. Rojo Agung No.153<br/>
                  Boro Utara, Curungrejo,<br/>
            ...
            <div class="flex max-w-full w-[330px] mb-8">
              ...
              <div>
                ...
                <p class="text-base text-body-color"><a href="mailto:contact@rakit.id?subject=Ngobrol%20Yuk!">contact@rakit.id</a></p>
              </div>
            </div>
          </div>
        </div>
