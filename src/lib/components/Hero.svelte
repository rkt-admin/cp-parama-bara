  <div class="px-4 py-10 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8">
    <div class="max-w-xl mb-10 md:mx-auto sm:text-center lg:max-w-2xl md:mb-12">
      <!-- <div>
        <p class="inline-block px-3 text-xs font-semibold tracking-wider uppercase">
          Brand new
        </p>
      </div> -->
    ...
    <div class="flex items-center sm:justify-center">
      <button
        type="submit"
        class="inline-flex items-center justify-center h-12 px-6 mr-6 font-medium tracking-wide text-white transition duration-200 rounded shadow-md bg-slate-800 hover:bg-slate-600 focus:shadow-outline focus:outline-none"
      >
        Get started
      </button>
...
<!-- <div class="relative px-4 sm:px-0">
  ...
  <div class="relative grid mx-auto overflow-hidden bg-slate-300 divide-y rounded shadow sm:divide-y-0 sm:divide-x sm:max-w-screen-sm sm:grid-cols-3 lg:max-w-screen-md">
