...
<div class="justify-center">
    ...
    <center class="m-auto">
        <svg
            ...
            width="226"
            xml:space="preserve"
            ><circle cx="113" cy="113" fill="#ffffff" r="109" /><line
                ...
                x2="58.732"
                y1="245.135"
                y2="245.135" /><circle cx="68.732" cy="93" fill="#6E6E96" r="9" /><path
                ...
                enable-background="new    "
                fill="#FF9900"
                opacity="0.24" /><circle cx="156.398" cy="93" fill="#6E6E96" r="9" /><ellipse
                cx="67.732"
                cy="140.894"
                enable-background="new    "
                fill="#FF0000"
        ...
        <div class=" tracking-widest mt-4">
            <span class="text-gray-500 text-5xl tracking-widest">{$page.status}</span>
            <div class="text-gray-500 text-xl mt-4 tracking-normal">
    ...
    <center class="mt-6">
        <button
            on:click={goSomeWhere}
            class="text-gray-500 font-mono text-base border p-2 bg-slate-200 rounded-md hover:bg-slate-400 hover:shadow-md hover:shadow-slate-400"
            >Go back</button>
    </center>
    <Divider size="small" />
</div>
