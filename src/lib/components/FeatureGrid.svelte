    ...
    >
      <span class="relative inline-block">
        <svg
          viewBox="0 0 52 24"
          fill="currentColor"
          class="absolute top-0 -right-28 z-0 hidden w-32 -mt-8 -ml-20 text-gray-400 lg:w-32 lg:-ml-28 lg:-mt-10 sm:block"
        >
          <defs>
            <pattern
        ...
        <span class="relative">Transaction</span>
      </span>
    </h2>
    ...
    <dl class="space-y-10 md:space-y-0 md:grid md:grid-cols-2 md:gap-x-8 md:gap-y-10">
      <div class="relative">
        <dt>
          ...
          <p class="ml-16 text-lg leading-6 font-medium">Competitive exchange rates</p>
        </dt>
      ...
      <div class="relative">
        <dt>
          ...
          <p class="ml-16 text-lg leading-6 font-medium ">No hidden fees</p>
        </dt>
        <dd class="mt-2 ml-16 text-base ">
          Lorem ipsum, dolor sit amet consectetur adipisicing elit. Maiores impedit perferendis
          suscipit eaque, iste dolor cupiditate blanditiis ratione.
      ...
      <div class="relative">
        <dt>
          ...
          <p class="ml-16 text-lg leading-6 font-medium">Transfers are instant</p>
        </dt>
        <dd class="mt-2 ml-16 text-base">
          Lorem ipsum, dolor sit amet consectetur adipisicing elit. Maiores impedit perferendis
          suscipit eaque, iste dolor cupiditate blanditiis ratione.
      ...
      <div class="relative">
        <dt>
          ...
          <p class="ml-16 text-lg leading-6 font-medium">Mobile notifications</p>
        </dt>
        <dd class="mt-2 ml-16 text-base">
          Lorem ipsum, dolor sit amet consectetur adipisicing elit. Maiores impedit perferendis
          suscipit eaque, iste dolor cupiditate blanditiis ratione.
