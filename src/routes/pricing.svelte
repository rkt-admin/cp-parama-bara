...
<div class="relative max-w-4xl mx-auto px-2 sm:px-2 lg:px-2">
    <div class="pricing-box max-w-lg mx-auto rounded-lg shadow-lg overflow-hidden lg:max-w-none lg:flex">
        <div class="bg-white dark:bg-gray-800 px-6 py-0 lg:flex-shrink-1 lg:py-0">
            <h3 class="m-0 p-0 text-2xl leading-8 font-extrabold text-gray-900 sm:text-3xl sm:leading-9 dark:text-white">
                Zero Commission
            </h3>
